...
static message_data_t _fa_blocks_data[] = {
	{
		.messages = {{0}, {0}, {0}, {0}, {0}, {0}, {0}, {0}},
		.message = {0},
		.hash = {0},
		.answer = VC_PRBS_CW_FA
	}
};
static _vc_block_t _fa_blocks[] = {
	{ .mode = 0x05, .message_data = &_fa_blocks_data[0] }
};

/* Blocks for VC2 free-access decoding */
static message_data_t _fa2_blocks_data[] = {
	{
		.messages = {{0}, {0}, {0}, {0}, {0}, {0}, {0}, {0}},
		.message = {0},
		.hash = {0},
...
static _vc_block_t _fa2_blocks[] = {
	{ .mode = 0x9C, .message_data = &_fa2_blocks_data[0] }
};

/* Generic conditional access VC1 blocks */
static message_data_t _vc1_blocks_data[] = {
	{
		.messages = {
			{0}, {0}, {0}, {0}, {0},
			{ 0xF8,0x0F,0x2C,0x2E,0x38,0x3B,0x01,0xFF,0xFF },
			{0}, {0}
		},
		.message = {0},
		.hash = {0},
...
static _vc_block_t _vc1_blocks[] = {
	{ .mode = 0x07, .message_data = &_vc1_blocks_data[0] },
	{ .mode = 0x07, .message_data = &_vc1_blocks_data[1] }
};

/* Blocks for VC1 conditional-access sample, taken from MTV UK, */
/* requires an active Sky 11 series card to decode */
static message_data_t _sky11_blocks_data[] = {
	{
		.messages = {
			{ 0x20 },
			{0}, {0}, {0}, {0},
	...
	},
	{
		...
		.message = {0},
		.hash = {0},
		.answer = 0xF9885DA50770B80UL
	}
};
static _vc_block_t _sky11_blocks[] = {
	{ .mode = 0x07, .message_data = &_sky11_blocks_data[0] },
	{ .mode = 0x07, .message_data = &_sky11_blocks_data[1] }
};

/* Blocks for VC1 conditional-access sample, taken from Sky One, */
/* requires an active Sky 12 series card to decode */
static message_data_t _sky12_blocks_data[] = {
	{
		.messages = {
			{0}, {0}, {0}, {0}, {0},
	...
	},
	{
		...
		.message = {0},
		.hash = {0},
		.answer = 0xC389AED26500336B
	}
};
static _vc_block_t _sky12_blocks[] = {
	{ .mode = 0x07, .message_data = &_sky12_blocks_data[0] },
	{ .mode = 0x07, .message_data = &_sky12_blocks_data[1] }
};

static message_data_t _xtea_blocks_data[] = {
	{
		.messages = {
			{ 0x20 },
			{0}, {0}, {0}, {0},
	...
	},
	{
		...
		.message = {0},
		.hash = {0},
		.answer = 0xD491B336D3D54BAUL
	}
};
static _vc_block_t _xtea_blocks[] = {
	{ .mode = 0x07, .message_data = &_xtea_blocks_data[0] },
	{ .mode = 0x07, .message_data = &_xtea_blocks_data[1] }
};

/* Blocks for VC2 conditional-access sample, taken from Discovery Channel. */
static message_data_t _vc2_blocks_data[] = {
	{
		.messages = {
...
static _vc_block_t _vc2_blocks[] = {
	{ .mode = 0xA0, .message_data = &_vc2_blocks_data[0] },
	{ .mode = 0xA0, .message_data = &_vc2_blocks_data[1] }
};

/* Blocks used in PPV/memory card mode */
static message_data_t _ppv_blocks_data[] = {
	{
		.messages = {
			{
				0xA8,
...
static _vc_block_t _ppv_blocks[] = {
	{ .mode = 0x07, .message_data = &_ppv_blocks_data[0] },
	{ .mode = 0x07, .message_data = &_ppv_blocks_data[1] }
};
